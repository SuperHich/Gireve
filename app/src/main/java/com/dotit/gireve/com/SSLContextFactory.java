...
public class SSLContextFactory {
    ...
    public MySSLSocketFactory makeSSLSocketFactory(File clientCertFile, String clientCertPassword) throws Exception{
        final KeyStore keyStore = loadPKCS12KeyStore(clientCertFile, clientCertPassword);
        KeyManagerFactory kmf = KeyManagerFactory.getInstance("X509");
        kmf.init(keyStore, clientCertPassword.toCharArray());
        KeyManager[] keyManagers = kmf.getKeyManagers();
...
//        final KeyStore trustStore = loadPEMTrustStore(caCertString);
        ...
        return new MySSLSocketFactory(keyStore, keyManagers, trustManagers);
    }
