...
public class SettingsActivity extends PreferenceActivity {
    ...
    private void setupSimplePreferencesScreen() {
        ...
        fakeHeader.setTitle(R.string.pref_header_search_settings);
        getPreferenceScreen().addPreference(fakeHeader);
        addPreferencesFromResource(R.xml.pref_search);

        // Add 'network' preferences, and a corresponding header.
        fakeHeader = new PreferenceCategory(this);
        fakeHeader.setTitle(R.string.pref_header_network_settings);
        getPreferenceScreen().addPreference(fakeHeader);
        ...
        bindPreferenceSummaryToValue(findPreference(getString(R.string.pref_key_search_algo)));
        bindPreferenceSummaryToValue(findPreference(getString(R.string.pref_key_max_count)));

        bindPreferenceSummaryToValue(findPreference(getString(R.string.pref_key_ip_address)));
        bindPreferenceSummaryToValue(findPreference(getString(R.string.pref_key_fault_response)));

        setContentView(R.layout.settings_layout);

        ((TextView) findViewById(R.id.txv_title)).setTypeface(GireveFonts.getClanProBold());
    }
...
//        String def = "";
//        if(preference.getKey().equals(preference.getContext().getString(R.string.pref_key_max_count)))
//            def = String.valueOf(NumberPickerPreference.DEFAULT_VALUE);
//
//        try {
...
//        }
    ...
    /**
     * This fragment shows search preferences only. It is used when the
